...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        <div class="navbar-header" >
          ...
          <div class="row" style="color:white;">
            <a class="navbar-brand" href="index.php" col-md-3>BookShop</a>
    ...
    <div class="jumbotron" style="  background: url('https://www.bl.uk/britishlibrary/~/media/bl/global/about%20us/around%20the%20building/bm-reading-room.jpg') no-repeat center center;background-size: cover;height:400px
;
  " >
      <div class="container">
      <h1 style="text-align:center; margin:5% auto; color: white; font-family: Arial, sans-serif;">Online Bookshop</h1>
      
      <h3 style="text-align:center; margin:5% auto; color: white; font-family: 'Arial', serif;">CSE470 PROJECT</h3>
